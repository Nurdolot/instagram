...
def followers(request, id):
    ...
    if request.method == 'POST':
        ...
        follower_status = Follows.objects.get(from_user_id = follower, to_user = user)
        follower_status.delete()
        return redirect('follower', user.id)
...
def follows(request, id):
    ...
    if request.method == 'POST':
        ...
        follow_status = Follows.objects.get(from_user = user, to_user_id = follow)
